      ...
      >
        <div className="mb-8 text-center">
          ...
          <h1 className="text-3xl font-extrabold tracking-tight text-white flex items-center justify-center gap-2">
            Documents <span className="bg-gradient-to-r from-blue-400 to-teal-400 bg-clip-text text-transparent">RAG</span>
            <Sparkles className="h-5 w-5 text-cyan-400 animate-pulse-slow" />
          </h1>
          <p className="mt-2 text-sm text-slate-400">Secure AI-powered document intelligence</p>
        </div>
